...
class BunnyFacts(Cog):
    ...
    def __init__(self, bot):
        ...
        self.facts = {
            "binky": {
            "summary": "What is a binky!?",
            "images": {"https://media-be.chewy.com/wp-content/uploads/2022/05/24112223/rabbit-binkying.gif",
            ...
            "fact": "When a rabbit does a weird twist and jump in the air, it\'s called a binky. Rabbits do this when they have so much happy energy that they just can\'t contain it. A binkying bunny is a very happy bunny!\n\n**Why do rabbits binky?**\n We don\'t really know why rabbits binky. All we know is that it\'s a normal instinct in rabbits. It\'s like an inexplicable expression of joy, much like laughing is for humans.\n[Link](https://bunnylady.com/bunny-binkies/)"
            },
            "flopping": {
            "summary": "Is that bunny dead? (no)",
            "images": {"https://live.staticflickr.com/2541/4222032144_9d2be8fdaa_b.jpg",
            ...
            "images": {"https://files.catbox.moe/dzgwnr.jpg",
            ...
            "images": {"https://64.media.tumblr.com/f2dc3fbe0834c9903e48a2c6818ed3d7/tumblr_o8158dq9Wh1uronh1o1_400.gif"},
            "fact": ""
            },
            "honking": {
            "summary": "Bunnies honk!?",
            "images": {""},
            "fact": ""
            },
            "grunting": {
            "summary": "Bunnies grunt too!?",
            "images": {""},
            "fact": ""
            },
            "boxing": {
    ...
    async def bunfact(self, ctx: commands.Context):
            ...
            for key, value in self.facts.items():
                help_embed.add_field(name=key.capitalize(), value=value["summary"], inline=True)
