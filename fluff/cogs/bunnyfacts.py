...
class BunnyFacts(Cog):
    ...
    async def bunfact(self, ctx, *, fact=None):
        ...
        if not fact:
            ...
            help_embed.add_field(name="Test1", inline=True)
            help_embed.add_field(name="Test2", inline=True)
            help_embed.add_field(name="Test3", inline=True)
            help_embed.add_field(name="Test4", inline=False)
            help_embed.add_field(name="Test5", inline=True)
            help_embed.add_field(name="Test6", inline=True)
            help_embed.add_field(name="Test7", inline=True)
            help_embed.add_field(name="Test8", inline=False)
            help_embed.add_field(name="Test9", inline=True)
            help_embed.add_field(name="Test10", inline=True)
            help_embed.add_field(name="Test11")
