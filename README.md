...
Fluff is a fork of [Sangou](https://github.com/vrnavi/sangou), which is a fork of [robocop-ng](https://github.com/reswitched/robocop-ng). The persona this bot takes on is based on a real person's bunny named Fluff.
